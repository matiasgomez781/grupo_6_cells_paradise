...
router.post("/", adminMid, upload.array("images"), productValidationMid.createProduct, productsController.store);

router.get("/:id/editProduct", adminMid, productsController.editProduct);
router.put("/:id", adminMid, upload.array("images"), productsController.editUpdate);
